...
KoaServer = (function() {
  function KoaServer(env1, engine) {
    this.env = env1;
    this.engine = engine;
  }

  KoaServer.httpSettings = env.getEnvProperty(ConfigHttpSection);

  KoaServer.initSettings = env.getEnvProperty(ConfigInitSection);

  KoaServer.localeSettings = env.getEnvProperty(ConfigLocaleSection);

  KoaServer.errorSettings = env.getEnvProperty(ConfigErrorSection);
