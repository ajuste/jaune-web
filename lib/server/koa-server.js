 ...
 */
'use strict';
var AppName, ConfigErrorSection, ConfigHttpSection, ConfigInitSection, ConfigLocaleSection, EnvType, EnvTypeDev, I18n, KoaServer, evaluateName, extend, handleError, http, https, koa, lodash, pick, register;
...
KoaServer = (function() {
  ...
  KoaServer.prototype.setupWeb = function() {
    var appName, cert, enabled, html, httpServer, key, opts, port, ref, ref1;
